        ...
        <header class="site-header">
            ...
            <div class="container">
                <div class="site-header-inner">
					...
					<a class="button button-primary button-block" href="{{ route('login') }}">Login Yukk</a>
					@if (Route::has('register'))
					<a class="button button-primary button-block" href="{{ route('register') }}">Register</a>
					@endif
					@else 
						<a id="navbarDropdown" class="nav-link dropdown-toggle button-block" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
